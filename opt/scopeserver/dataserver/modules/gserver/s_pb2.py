...
DownloadSubLoomRequest = _reflection.GeneratedProtocolMessageType('DownloadSubLoomRequest', (_message.Message,), dict(
...
DownloadSubLoomReply = _reflection.GeneratedProtocolMessageType('DownloadSubLoomReply', (_message.Message,), dict(
